...
# 초기 그룹화된 버블
initial_groups = {
    "기술(Technology)": ["1. 시민들은 데이터센터가 재생에너지를 쓰면 환경에 책임 있다고 느낄 수 있다.",
    ...
    "사람(People)": ["1. 시민들은 데이터센터 건설에 자신의 의견이 반영되지 않으면 반발할 수 있다.",
    ...
    "장소(Place)": ["1. 시민들은 공장이나 발전소 부지를 재활용한 데이터센터에 더 호감을 가질 수 있다.",
    ...
    "과정(Process)": ["1. 시민들은 데이터센터 정보가 초기에 투명하게 공개되면 신뢰할 수 있다고 느낄 수 있다.",
