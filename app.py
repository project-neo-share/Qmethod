...
# 초기 그룹화된 버블
initial_data = [
    {"header": "기술(Technology)", "items": ["1. 시민들은 데이터센터가 재생에너지를 쓰면 환경에 책임 있다고 느낄 수 있다.",
                "2. 시민들은 데이터센터가 디젤이나 가스 발전기를 백업 전력으로 쓰면 환경에 해롭다고 생각할 수 있다.",
                "3. 시민들은 데이터센터가 물 절약이나 친환경 냉각 기술을 쓰면 더 신뢰할 수 있다고 느낄 수 있다.",
                "4. 시민들은 데이터센터가 최신 기술을 쓰더라도 안전하지 않으면 불안해할 수 있다.",
                "5. 시민들은 데이터센터 기술이 비용보다 사회적 책임을 우선해야 한다고 생각할 수 있다.",
                "6. 시민들은 데이터센터 기술이 너무 낯설거나 복잡하면 거리감을 느낄 수 있다."]},
    {"header": "사람(People)", "items": ["1. 시민들은 데이터센터 건설에 자신의 의견이 반영되지 않으면 반발할 수 있다.",
                "2. 시민들은 지역과 오랫동안 관계를 맺은 기업의 데이터센터를 더 신뢰할 수 있다.",
                "3. 시민들은 데이터센터 설명회가 형식적으로 보이면 불신을 가질 수 있다.",
                "4. 시민들은 정보에 접근하기 어려우면 데이터센터에 불안감을 가질 수 있다.",
                "5. 시민들은 중립적인 제3자가 갈등을 조정하면 도움이 된다고 느낄 수 있다.",
                "6. 시민들은 동일한 내용이라도 데이터센터 기업보다는 정부의 설명을 더 신뢰한다."]},
    {"header": "장소(Place)", "items": ["1. 시민들은 공장이나 발전소 부지를 재활용한 데이터센터에 더 호감을 가질 수 있다.",
                "2. 시민들은 데이터센터가 지역 정체성과 어울리지 않으면 거부감을 느낄 수 있다.",
                "3. 시민들은 자연경관을 훼손하는 데이터센터는 기술이 좋아도 받아들이기 어렵다고 느낄 수 있다.",
                "4. 시민들은 수도권과 지방이 데이터센터를 받아들이는 기준이 다르다고 느낄 수 있다.",
                "5. 시민들은 지역과 무관한 외부투자자나 글로벌 기업이 일방적으로 입지를 정할 경우 지역사회를 고려하지 않은 이익 중심 판단이라고 느껴 신뢰하지 않을 수 있다.",
                "6. 시민들은 데이터센터가 지역에 실질적 혜택을 줄 경우 더 수용할 수 있다."]},
    {"header": "과정(Process)", "items": ["1. 시민들은 데이터센터 정보가 초기에 투명하게 공개되면 신뢰할 수 있다고 느낄 수 있다.",
                "2. 시민들은 환경영향평가 결과가 수용 여부 판단에 중요하다고 생각할 수 있다.", 
                "3. 시민들은 기업과 지자체가 함께 결정한 데이터센터를 더 신뢰할 수 있다.",
                "4. 시민들은 데이터센터 사업이 법적 요건을 충족했다고 해서 신뢰까지 얻기는 어렵다고 느낄 수 있다.",
                "5. 시민들은 지역 언론이 데이터센터 관련 보도를 신속하고 정확하게 전달할 때 더 신뢰성이 높다고 느낀다.",
